...
INSERT INTO `plataforma` (`id`, `nombre`, `logo`) VALUES
...
INSERT INTO `usuario` (`id`, `nombre`, `apellidos`, `email`, `identificador`, `contrasenna`, `codigoCookie`, `administrador`) VALUES
(1, 'jlopez', 'José', 'López', 'j@j.com', 'j', '', NULL),
(2, 'i', 'Iván', 'Rodríguez', 'i@i.com', 'i', '', 1);
...
--
ALTER TABLE `carrito`
  ADD KEY `fk_carrito_pedidoId` (`pedidoId`),
  ADD KEY `fk_carrito_juegoId` (`juegoId`) USING BTREE;
...
ALTER TABLE `pedido`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_pedido_usuarioId` (`usuarioId`);
...
ALTER TABLE `resenia`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_resenia_juegoId` (`juegoId`),
  ADD KEY `fk_resenia_usuarioId` (`usuarioId`) USING BTREE;
...
ALTER TABLE `wishlist`
  ADD KEY `fk_wishlist_usuarioId` (`usuarioId`),
  ADD KEY `fk_wishlist_juegoId` (`juegoId`);
...
--
ALTER TABLE `carrito`
  ADD CONSTRAINT `carrito_ibfk_1` FOREIGN KEY (`pedidoId`) REFERENCES `pedido` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
ALTER TABLE `resenia`
  ADD CONSTRAINT `resenia_ibfk_2` FOREIGN KEY (`juegoId`) REFERENCES `juego` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `resenia_ibfk_3` FOREIGN KEY (`usuarioId`) REFERENCES `usuario` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `wishlist`
--
ALTER TABLE `wishlist`
  ADD CONSTRAINT `wishlist_ibfk_2` FOREIGN KEY (`juegoId`) REFERENCES `juego` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `wishlist_ibfk_3` FOREIGN KEY (`usuarioId`) REFERENCES `usuario` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
